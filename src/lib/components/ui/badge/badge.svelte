<script lang="ts" module>
	...
	export const badgeVariants = tv({
		...
		variants: {
			variant: {
				default:
					"bg-primary text-primary-foreground [a&]:hover:bg-secondary [a&]:hover:text-secondary-foreground border-transparent",
				secondary:
					"bg-secondary text-secondary-foreground [a&]:hover:bg-primary [a&]:hover:text-primary-foreground border-transparent",
				destructive:
